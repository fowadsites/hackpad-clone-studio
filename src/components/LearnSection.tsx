...
const LearnSection = () => {
  ...
  return <section id="learn" ref={ref} className={`min-h-screen flex items-center justify-center px-4 py-20 relative overflow-hidden bg-gradient-to-br from-background via-primary/5 to-background transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
      {/* Educational Background Elements */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-20 left-20 w-56 h-56 border-8 border-primary/10 rounded-full animate-spin" style={{
        ...
        <div className="absolute top-1/2 right-10 w-32 h-32 bg-primary/5 rounded-full blur-2xl animate-bounce" style={{
      ...
      <div className="max-w-6xl w-full relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          {tutorials.map((tutorial, index) => <div key={index} className="bg-card border-4 border-primary rounded-2xl p-8 hover:border-secondary transition-colors group shadow-lg">
              <div className="flex items-start justify-between mb-4">
                ...
                <Button variant="ghost" size="sm" className="text-primary hover:text-primary/80 pixel-text">
