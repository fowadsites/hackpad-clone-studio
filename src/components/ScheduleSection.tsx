...
const ScheduleSection = () => {
  ...
  const events = [
    { title: "Week 1", subtitle: "March 15-21" },
    { title: "Week 2", subtitle: "March 22-28" },
    { title: "Week 3", subtitle: "March 29 - April 4" },
    { title: "Finals", subtitle: "April 5" },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-10 right-10 w-64 h-64 bg-gradient-to-tl from-secondary/10 to-transparent rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
      ...
      <div className="max-w-6xl w-full relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {events.map((event, index) => (
            <div
              key={index}
              className="bg-card border-4 border-primary rounded-2xl p-8 shadow-lg hover:scale-105 transition-transform"
            >
