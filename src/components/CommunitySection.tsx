...
const CommunitySection = () => {
  ...
  return <section id="community" ref={ref} className={`min-h-screen flex items-center justify-center px-4 py-20 relative overflow-hidden bg-gradient-to-b from-muted/20 to-background transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
      {/* Network/Connection Pattern */}
      <div className="absolute inset-0 pointer-events-none opacity-40">
        <div className="absolute top-20 left-1/4 w-3 h-3 bg-primary rounded-full animate-ping" style={{
        animationDuration: '3s'
      }}></div>
        <div className="absolute top-40 left-1/3 w-3 h-3 bg-secondary rounded-full animate-ping" style={{
        animationDuration: '4s',
        animationDelay: '1s'
      }}></div>
        <div className="absolute top-60 left-1/2 w-3 h-3 bg-primary rounded-full animate-ping" style={{
        animationDuration: '5s',
        animationDelay: '2s'
      }}></div>
        <div className="absolute bottom-40 right-1/4 w-3 h-3 bg-secondary rounded-full animate-ping" style={{
        animationDuration: '3.5s',
        animationDelay: '0.5s'
      }}></div>
        <div className="absolute bottom-20 right-1/3 w-3 h-3 bg-primary rounded-full animate-ping" style={{
        ...
        <div className="absolute bottom-10 right-10 w-56 h-56 bg-secondary/10 rounded-full blur-3xl animate-pulse" style={{
        animationDelay: '1s'
      }}></div>
      </div>
      <div className="max-w-6xl w-full relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          ...
          <div className="bg-card border-4 border-primary rounded-2xl p-8 text-center shadow-lg">
            ...
            <div className="space-y-4">
              {teamMembers.map((member, index) => <div key={index} className="flex flex-col items-center gap-2">
