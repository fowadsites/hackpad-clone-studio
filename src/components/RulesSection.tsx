...
const RulesSection = () => {
  ...
  const rules = [
    "Be respectful to all participants and organisers",
    "No plagiarism - build your own ideas",
    "AI tools allowed - just disclose what you use",
    "No hate speech, NSFW, or harmful projects",
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-10 right-10 w-72 h-72 bg-gradient-to-tl from-secondary/10 via-primary/5 to-transparent rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
